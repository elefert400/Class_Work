...
int main (int argc, char *argv[])
{
   ...
   */
   ...
   {
     err_sys("ERROR: Can't gather file status");
   }
  /*
   ...
   */
   ...
   {
     err_sys("ERROR: Can't allocate the memory for the output file");
   }
  /*
   ...
   */
   if(write(fdout, "", 1) == -1)
   {
     err_sys("ERROR: Can't write dummy byte to file");
   }
  /*
   ...
   */
   ...
   {
     err_sys("ERROR: Can't perform memmap for source file");
   }
  /*
